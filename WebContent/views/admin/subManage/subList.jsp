	...
	<body onload="startTime()">
		...
		<div class="nav-down">
			...
			<div class="rightcon">
				...
				<form class="form-horizontal" role="form" id="teaForm" action="${pageContext.request.contextPath}/subject/querySub">
				
					<div class="form-group">
						<label class="col-sm-2 control-label"><font size="4px">编号查找</font></label>
						<div class="col-sm-7">
							<input type="text" class="form-control " name="querySubject_no">
						</div>
						<div class="col-sm-1">
				...
				<label style="margin-left:150px"><font size="4px">课程管理</font></label>
				...
				<table class="table table-condensed" style="width:80%;" align="center">
					...
					<tbody>
						...
						<tr>
							<td><c:out value="${subject.getSubject_no() }"></c:out></td>
							<td><c:out value="${subject.getSubject_name() }"></c:out></td>
							<td><c:out value="${subject.getSubject_addtime() }"></c:out></td>
							<td>
								<a href="${pageContext.request.contextPath}/subject/updateSubInit?subject_no=${subject.getSubject_no()  }">修改</a>
								<a href="${pageContext.request.contextPath}/subject/deleteSub?subject_no=${subject.getSubject_no()  }">删除</a>
							</td>
						</tr>
						</c:forEach>
				...
				<div style="margin-left:150px">
					<br>
					<font size=""> 共 <c:out value="${requestScope.subList.size() }"></c:out> 条数据</font>
				</div>
			</div>
		</div>
