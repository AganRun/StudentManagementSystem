	...
	<body onload="startTime()">
		...
		<div class="nav-down">
			...
			<div class="rightcon">
				...
				<form class="form-horizontal" role="form" id="teaForm" action="${pageContext.request.contextPath}/subject/saveSubject">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" name="subject_no"  readonly="readonly" value="${requestScope.updateSubDate.getSubject_no()}" type="text" >
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">课程名称</label>
						<div class="col-sm-6">
							<input class="form-control" name="subject_name" value="${requestScope.updateSubDate.getSubject_name()}" type="text" >
						</div>
					</div>
