	...
	<body onload="startTime()">
		...
		<div class="nav-down">
			...
			<div class="rightcon">
				...
				<form class="form-horizontal" role="form" id="clasForm" action="${pageContext.request.contextPath}/class/updateClassSave">
				
					<div style="height:100px"></div>
					<div class="form-group">
						<label class="col-sm-2 control-label"><font size="4px">班级信息修改</font></label>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" name="class_name" value="${requestScope.updateDate.getClass_name() }" type="text" >
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">所属院系</label>
						<div class="col-sm-6">
							<input class="form-control" name="class_department" value="${requestScope.updateDate.getClass_department() }"  type="text" >
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">班主任</label>
						<div class="col-sm-6">
							<select class="form-control" name="class_teacher_no">
								<option value="${requestScope.updateDate.getClass_teacher_no() }"><c:out value="${requestScope.updateDate.getClass_teacher_name() }"></c:out></option>
								<c:forEach items="${requestScope.teaList }" var="teacher">
									<c:if test="${requestScope.updateDate.getClass_teacher_no() !=  teacher.getTeach_no() }">
										<option value="${ teacher.getTeach_no() }"><c:out value="${teacher.getTeach_name() }"></c:out></option>
									</c:if>
								</c:forEach>
							</select>
						</div>
					...
					<input type="hidden" name="class_no" value="${requestScope.updateDate.getClass_no() }">
