	...
	<body onload="startTime()">
		...
		<div class="nav-down">
			...
			<div class="rightcon">
				...
				<form class="form-horizontal" role="form" id="clasForm" action="${pageContext.request.contextPath}/class/addClass">
				
					<div style="height:100px"></div>
					<div class="form-group">
						<label class="col-sm-2 control-label"><font size="4px">班级添加</font></label>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" name="class_department"  type="text" >
						</div>
					</div>
					<div class="form-group">
