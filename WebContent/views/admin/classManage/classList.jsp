	...
	<body onload="startTime()">
		...
		<div class="nav-down">
			...
			<div class="rightcon">
				...
				<label style="margin-left:120px"><font size="4px">班级添加</font></label>
				<div style="height:15px"></div>
				
				<table class="table table-condensed" style="width:84%;" align="center">
					<thead>
						<tr class="active">
							<th>编号</th>
							<th>名称</th>
					...
					<tbody>
						...
						<tr>
							<td><c:out value="${classEntity.getClass_no() }"></c:out></td>
							<td><c:out value="${classEntity.getClass_name() }"></c:out></td>
							<td><c:out value="${classEntity.getClass_department() }"></c:out></td>
							<td><c:out value="${classEntity.getClass_teacher_name() }"></c:out></td>
							<td><c:out value="${classEntity.getClass_addtime() }"></c:out></td>
							<td>
								<a href="${pageContext.request.contextPath}/class/updateClassInit?class_no=${classEntity.getClass_no() }">修改</a>
								<a href="${pageContext.request.contextPath}/class/deleteClass?class_no=${classEntity.getClass_no() }">删除</a>
							</td>
						</tr>
						</c:forEach>
				...
				<div style="margin-left:120px">
					<br>
					<font size=""> 共 <c:out value="${requestScope.classList.size() }"></c:out> 条数据</font>
				</div>
			</div>
		</div>
