	...
	<body onload="startTime()">
		...
		<div class="nav-down">
			...
			<div class="rightcon">
				...
				<form class="form-horizontal" role="form" id="teaForm" action="${pageContext.request.contextPath}/teacher/saveTeacher">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" name="teach_password" value="${requestScope.updateTeaDate.getTeach_password() }"  type="text" >
						</div>
					</div>
					<div class="form-group">
