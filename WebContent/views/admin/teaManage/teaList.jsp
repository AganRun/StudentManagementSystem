	...
	<body onload="startTime()">
		...
		<div class="nav-down">
			...
			<div class="rightcon">
				...
				<form class="form-horizontal" role="form" id="teaForm" action="${pageContext.request.contextPath}/teacher/queryTeacher">
				
					<div class="form-group">
						<label class="col-sm-2 control-label"><font size="4px">工号查找</font></label>
						<div class="col-sm-7">
							<input type="text" class="form-control " name="queryTeach_no">
						</div>
						<div class="col-sm-1">
				...
				<table class="table table-condensed" style="width:92%;" align="center">
					...
					<tbody>
						...
						<tr>
							<td><c:out value="${teacher.getTeach_no() }"></c:out></td>
							<td><c:out value="${teacher.getTeach_password() }"></c:out></td>
							<td><c:out value="${teacher.getTeach_name() }"></c:out></td>
							<td><c:out value="${teacher.getTeach_gender() }"></c:out></td>
							<td><c:out value="${teacher.getTeach_tel() }"></c:out></td>
							<td><c:out value="${teacher.getTeach_subject_name() }"></c:out></td>
							<td><c:out value="${teacher.getTeach_birth() }"></c:out></td>
							<td><c:out value="${teacher.getTeach_remark() }"></c:out></td>
							<td><c:out value="${teacher.getTeach_addtime() }"></c:out></td>
							<td>
								<a href="${pageContext.request.contextPath}/teacher/updateTeachInit?teach_no=${teacher.getTeach_no() }">修改</a>
								<a href="${pageContext.request.contextPath}/teacher/deleteTeach?teach_no=${teacher.getTeach_no() }">删除</a>
							</td>
						</tr>
						</c:forEach>
				...
				<div style="margin-left:70px">
					<br>
					<font size=""> 共 <c:out value="${requestScope.tealist.size() }"></c:out> 条数据</font>
				</div>
			</div>
		</div>
