	...
	<body onload="startTime()">
		...
		<div class="nav-down">
			...
			<div class="rightcon">
				...
				<form class="form-horizontal" role="form" id="teaForm" action="${pageContext.request.contextPath}/student/saveStudent">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" name="stu_name" value="${requestScope.updateStuDate.getStu_name() }" type="text" >
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">密码</label>
						<div class="col-sm-6">
							<input class="form-control" name="stu_password" value="${requestScope.updateStuDate.getStu_password() }"  type="password" >
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<textarea rows="3" name="stu_remark" class="form-control"><c:out value="${requestScope.updateStuDate.getStu_remark() }"></c:out></textarea>
						</div>
					</div>
					
					<input type="hidden" name="stu_no" value="${requestScope.updateStuDate.getStu_no() }">
