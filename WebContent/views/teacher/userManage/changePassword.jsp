	...
	<script type="text/javascript">
		$(function(){
			$("#changePwdForm").validate({
			    // 添加验证规则
			    rules: {
			    	teach_oldPwd: "required",
			    	teach_newPwd: "required",
			    	teach_repeat:{
			    		equalTo:'#teach_newPwd',
			    	}
			    },
	...
	<body onload="startTime()">
		...
		<div class="nav-down">
			...
			<div class="rightcon">
				...
				<form class="form-horizontal" role="form" id="changePwdForm" action="${pageContext.request.contextPath }/teacherManage/changePwd">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" name="teach_oldPwd" type="password" >
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">新密码</label>
						<div class="col-sm-6">
							<input class="form-control" id="teach_newPwd" name="teach_newPwd"  type="password" >
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">确认密码</label>
						<div class="col-sm-6">
							<input class="form-control" name="teach_repeat"  type="password" >
						</div>
					</div>
